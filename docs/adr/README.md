...
| [0040](0040-the-event-envelope.md) | Every published event carries a correlation id, a causation id and a contract version — beside the event, not inside it | Accepted |
