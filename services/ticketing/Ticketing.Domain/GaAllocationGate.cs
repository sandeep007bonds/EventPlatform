...
/// <c>EventScanContextProvisioningService</c>, combining Catalog's seat-map gate map with
...
public sealed class GaAllocationGate
{
    ...
    private GaAllocationGate(Guid allocationId, Guid eventId, Guid entryGateId)
    {
    ...
    public static GaAllocationGate Create(Guid allocationId, Guid eventId, Guid entryGateId) => new(allocationId, eventId, entryGateId);
}
