...
internal sealed class InventoryItemConfiguration : IEntityTypeConfiguration<InventoryItem>
{
    ...
    public void Configure(EntityTypeBuilder<InventoryItem> builder)
    {
        ...
        builder.Property(i => i.CatalogEventId).IsRequired();
        ...
        builder.HasIndex(i => new { i.EventSessionId, i.SeatId }).IsUnique();
        builder.HasIndex(i => new { i.EventSessionId, i.Status });
    }
}
