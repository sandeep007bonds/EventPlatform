...
public sealed class DeliveryLogEntry
{
    ...
    /// <summary>The integration event id that triggered this send, if it came from a subscriber rather than the direct API.</summary>
    ...
    /// <param name="correlationId">The triggering integration event id, if any.</param>
        ...
        Guid? correlationId)
    {
        ...
        return new DeliveryLogEntry(tenantId, channel, recipient, templateKey, DeliveryStatus.Sent, provider, providerReference, failureReason: null, correlationId);
    }
        ...
        Guid? correlationId)
    {
        ...
        return new DeliveryLogEntry(tenantId, channel, recipient, templateKey, DeliveryStatus.Failed, provider, providerReference: null, failureReason, correlationId);
    }
    ...
    /// <param name="correlationId">The triggering integration event id.</param>
    ...
    public static DeliveryLogEntry Skipped(
        ...
        Guid correlationId)
    {
        return new DeliveryLogEntry(tenantId, channel, recipient: null, templateKey, DeliveryStatus.Skipped, provider: "none", providerReference: null, failureReason: "no recipient contact info resolved", correlationId);
    }
}
