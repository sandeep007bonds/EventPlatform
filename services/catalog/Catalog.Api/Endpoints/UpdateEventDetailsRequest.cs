...
/// <summary>
/// Request body for updating a draft event's dates, venue and pricing rules. The tenant is taken
/// from the caller's token, never from this body (ADR-0011).
/// </summary>
/// <remarks>
/// Title, description, imagery and contact details are <b>not</b> here — they go to
/// <c>PUT /v1/events/{id}/presentation</c>, which works after publish too.
/// </remarks>
