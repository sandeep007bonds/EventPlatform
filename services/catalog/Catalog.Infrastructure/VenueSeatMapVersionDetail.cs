...
/// <param name="Sections">Reserved-seating sections; only their codes and seat counts are read.</param>
/// <param name="AdmissionAreas">Unreserved capacity areas; only their codes and capacities are read.</param>
internal sealed record VenueSeatMapVersionDetail(
    Guid Id,
    int VersionNumber,
    string Status,
    int Capacity,
    IReadOnlyList<VenueSectionBlock> Sections,
    IReadOnlyList<VenueAdmissionAreaBlock> AdmissionAreas);
